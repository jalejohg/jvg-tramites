/**
 * Listado de países del mundo en español (es_MX) con su bandera (emoji)
 * y código ISO 3166-1 alpha-2. Pensado para el selector buscador del
 * formulario de contacto. El `name` es lo que se envía y se almacena.
 */
export interface Country {
  /** Código ISO 3166-1 alpha-2 (sirve como key estable). */
  code: string;
...
export const COUNTRIES: Country[] = [
  ...
  { code: "CD", name: "Congo (República Democrática)", flag: "🇨🇩" },
  ...
  { code: "VA", name: "Vaticano (Ciudad del)", flag: "🇻🇦" },
...
/** Normaliza un texto para búsqueda sin acentos ni mayúsculas. */
